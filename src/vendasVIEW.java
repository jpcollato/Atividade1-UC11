...
public class vendasVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        produtosVendidos.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
    ...
    private void listarProdutosVendidos() {
        try {
            ...
            for (int i = 0; i < listagemVendidos.size(); i++) {
                ProdutosDTO p = listagemVendidos.get(i);
                String id = String.valueOf(p.getId());
                String valor = String.valueOf(p.getValor());
            ...
            produtosVendidos.setModel(model);
